...
{
    public class ClienteCreateContract : Contract<ClienteCreateCommand>
    {
        public ClienteCreateContract(ClienteCreateCommand request)
        {
            Requires()
        ...
        static bool Validacao(ClienteCreateCommand request)
        {
